...
const SearchScene = (props: SearchSceneProps) => {
  const setIsHovering = props.sceneNavigator?.viroAppProps?.setIsHovering;

  var categoryTitle = props.searchText || "UNKNOWN"

  if (categoryTitle.includes("pepper")) {
    categoryTitle = "Peppers"
  } else if (categoryTitle.includes("chocolate")) {
    categoryTitle = "Chocolate"
  }
  ...
  return (
    <ViroARScene>
      ...
      >
        ...
        {
          categoryTitle.includes("Chocolate") ?
            <ViroFlexView
            ...
            >
              ...
              <ViroFlexView style={styles.row} width={2.6} height={0.7}>
                ...
                <GazeImageButton
                  ...
                  source={require("../../assets/recipes/chocolatePudding.png")}
                />
              </ViroFlexView>
              ...
              <ViroFlexView style={styles.row} width={2.6} height={0.7}>
                <GazeImageButton
                  ...
                  onClick={
                    () =>
                      props.sceneNavigator.replace({
                        scene: RecipeDetailScene,
                        passProps: {
                          recipeName: "Chocolate Sphere",
                          recipeDescription: "Be careful with the cooking time, many peppers can be tricky!",
                          recipeIngredients: ["5 Red Bell Pepper"],
                          recipeDifficulty: 5,
                          recipeTime: 3,
                          setIsHovering: setIsHovering
                        }
                  ...
                  source={require("../../assets/recipes/chocolateGanache.png")}
                />
                <GazeImageButton
                  position={[0, 0, 0]} width={0.9} height={0.7}
                  onClick={
            ...
            >
              ...
              <ViroFlexView style={styles.row} width={2.6} height={0.7}>
                ...
                <GazeImageButton
                  ...
                  onClick={
                    () =>
                      props.sceneNavigator.replace({
                        scene: RecipeDetailScene,
                        passProps: {
                          recipeName: "Ciambotta",
                          recipeDescription: "Roast a red bell pepper, making sure not to burn it!",
                          recipeIngredients: ["1 Red Bell Pepper", "1 Cucumber"],
                          recipeDifficulty: 1,
                          recipeTime: 1,
                          setIsHovering: setIsHovering
                        }
                  ...
                  source={require("../../assets/recipes/ciambottaImage.png")}
                />
              </ViroFlexView>
              ...
              <ViroFlexView style={styles.row} width={2.6} height={0.7}>
                <GazeImageButton
                  ...
                  source={require("../../assets/recipes/peperonata.png")}
                />
                <GazeImageButton
                  position={[0, 0, 0]} width={0.9} height={0.7}
                  onClick={
                    () =>
                      props.sceneNavigator.replace({
                        scene: RecipeDetailScene,
                        passProps: {
                          recipeName: "Sweet peppers",
                          recipeDescription: "Glaze the peppers with vinegar without making them sticky!",
                          recipeIngredients: ["1 Red Bell Pepper", "1 tbsp vinegar"],
                          recipeDifficulty: 2,
                          recipeTime: 4,
                          setIsHovering: setIsHovering
                        }
                  ...
                  source={require("../../assets/recipes/sweetPeppers.png")}
                />
              </ViroFlexView>
            </ViroFlexView>
        }
      ...
      { /*}
      <RoundGazeButton
        position={[1.38, -0.2, -3.5]} width={0.25} height={0.25}
        text=">"
