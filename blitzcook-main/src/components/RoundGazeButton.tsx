...
const RoundGazeButton: React.FC<GazeButtonProps> = ({
  position, width, height, text, onClick, onHoverChange, styleText
}) => {
  ...
  return (
    <ViroFlexView
      ...
      materials={isHovering ? ["btnHoverRound"] : ["btnNormalRound"]}
      onHover={handleHover}
      position={position}
    >
      <ViroText
...
export default RoundGazeButton;